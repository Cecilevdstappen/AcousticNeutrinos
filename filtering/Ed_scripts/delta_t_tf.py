...
#                pp.show()
                ...
                delta_t = data.sample_times[entry_point] - (peak_t) # 0.006 s is starting time of template
...
#                pp.legend()
#                pp.show()
            aFile=open('../Neutrino_data_files/deltat_SNR_'+str(rpos)+'_'+str(round(float(zpos),1))+'_'+str(energy)+'_tf.dat', 'wb')
