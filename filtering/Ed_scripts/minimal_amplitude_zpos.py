...
# -*- coding: utf-8 -*-
"""
Created on Thu May 26 09:28:21 2022
...
for zpos in (10,50):
    for scale in (10,1000):
        ...
        #data_file = '../Neutrino_data_files/neutrino' + '_' + str(zpos) + '_' + str(ypos) + '_' + str(scale) + '.txt' #'whitenoise.txt'
        #data_file = '../Neutrino_data_files/neutrino_' +str(zpos)+'_300_'+str(scale)+'fixed.txt'
    ...
    #    pp.close()
        ...
        #for i in L_snr:
        for j in np.arange(0,len(L_segment)-1,1):
            max_snr = 0.
            ...
            print("Maximum SNR (z={}) = {:5.2f} at t = {:.4f} s for amplitude {:.4f}, scaling ={:.4f}".format(zpos, max_snr, max_snr_time, max(amplitude_og*scale), scale))
